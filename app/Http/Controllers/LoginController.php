...
//--------------------------------------------------------------agregar/ administrador / juguete -----------------------------------------------------------------
        ...
        public function guardar4(Request $request){
            ...
            $juguete = JuguetesModel::create(array(
                'img'=>$img2,
                'nombre'=>$request->input('nombre'),
...
//--------------------------------------------------------------editar Juguete -----------------------------------------------------------------
        ...
        public function editar3(JuguetesModel $id){
            return view("content.editar3")
                ->with(['juguete' => $id]);
            }
    
        public function salvar3(JuguetesModel $id, Request $request){
            ...
            if($request->file('img1') !=''){
                ...
                $con = JuguetesModel::find($id->id_juguete);
                    $con -> img = $img2;
                ...
                return redirect()->route('mostrar3', ['id' => $id->id_juguete]);
        }
//--------------------------------------------------------------borrar usuario -----------------------------------------------------------------
...
//-------------------------------------------------------------- Detalle -----------------------------------------------------------------
    ...
    {
        $juguete = JuguetesModel::find($id);
        return view("detalle.detalle")
        ->with(['juguete' => $juguete]);
    }
